...
const CACHE='neko-nine-v4';
const CORE=['./','./index.html','./manifest.webmanifest','./js/loop.js','./js/sprites.js','./js/audio.js','./js/title.js','./js/engine.js','./js/stages.js','./js/render.js','./js/main.js'];
